...
* Primary Key: variable o conjunto de variables que identifica unívocamente una observación en su propia tabla.

* Foreign Key: variable o conjunto de variables de una tabla que se corresponden con la Primary Key de otra tabla.
...
* Una *primary key* y su *foreign key* en otra tabla forman una **relación**.
